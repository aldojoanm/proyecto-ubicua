 ...
 * 
 * Explicitly creates beans for:
 * - UseCases from core-platform (injecting Ports from adapters)
 * - Orchestrators from iam-service (injecting UseCases)
 * 
 * Uses @ConditionalOnMissingBean to allow overrides in future extraction phases.
 * This enables gradual migration: new implementations can be provided without breaking existing wiring.
 */
@Configuration
