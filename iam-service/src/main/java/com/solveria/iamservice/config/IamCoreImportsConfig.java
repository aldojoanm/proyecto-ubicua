 ...
 * 
 * Creates beans of RoleRepositoryPort and PermissionRepositoryPort by instantiating
 * the adapters explicitly, rather than relying on @Component scan or @Import.
 * 
 * This approach:
 * - Avoids scanning the entire core-platform package
 * - Makes dependencies explicit and visible
 * - Facilitates gradual extraction: when IAM is extracted, only this config needs to change
 * - Allows easy override with @ConditionalOnMissingBean in future phases
 */
@Configuration
